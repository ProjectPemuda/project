...
case 'command':
 ...
 description: `Hai kak @${sender.split('@')[0]}, Silahkan pilih menu disini, Kalau lu makek Wa GB, dan gak muncul, Ketik .allmenu`,
 sections: [
                     {
...
case '100💎':
       ...
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 100 diamond dengan harga IDR 15.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay2`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '140💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 140 diamond dengan harga IDR 20.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay3`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '210💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 210 diamond dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay4`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '355💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 355 diamond dengan harga IDR 50.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay5`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '500💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 500 diamond dengan harga IDR 70.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay6`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '720💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 720 diamond dengan harga IDR 100.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay7`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1000💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1000 diamond dengan harga IDR 140.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay8`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1215💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1215 diamond dengan harga IDR 167.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay9`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '2005💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 2005 diamond dengan harga IDR 270.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay10`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '4005💎':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 4005 diamond dengan harga IDR 535.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay11`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳mingguan':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.MINGGUAN dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay12`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳bulanan':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.BULANAN dengan harga IDR 117.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay13`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//ini pembayaran ny//
break
case 'pay1':
       ...
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay1`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana1`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo1`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay2':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay2`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana2`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo2`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay3':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay3`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana3`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo3`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay4':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay4`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana4`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo4`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay5':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay5`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana5`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo5`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay6':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay6`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana6`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo6`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay7':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay7`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana7`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo7`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay8':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay8`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana8`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo8`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay9':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay9`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana9`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo9`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay10':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay10`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana10`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo10`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay11':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay11`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana11`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo11`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay12':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay12`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana12`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo12`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay13':
        case '0':
        stod = `${sender}`
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay13`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana13`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo13`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//ini nomer nya //
case 'gopay1':
 listMsg = {
...
Giliran = @${tty.er1.split('@')[0]}`
 pemuda.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.er1,tty.er2]}})
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Pemuda Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://youtu.be/mw9tozDy8ok"}}})
	}
    }
    }
    }
